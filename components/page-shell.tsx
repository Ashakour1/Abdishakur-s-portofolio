  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-12 px-5 py-14 sm:px-6 sm:py-20">
      <section className="fade-up space-y-6">
        <p className="text-[11px] uppercase tracking-[0.32em] text-subtle">
          {eyebrow}
        </p>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.35fr_0.65fr] lg:items-end">
          ...
          {aside ? (
            <div className="min-w-0 rounded-3xl border border-line bg-surface p-6 text-sm leading-7 text-muted">
              {aside}
            </div>
          ) : null}
        </div>
